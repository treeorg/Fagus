...
First off, welcome and thank you for taking the time to contribute to TreeO! Any contribution, big or small, is welcome to make TreeO more useful such that more people can benefit from it. 

The following is a set of guidelines for contribution to TreeO, which is hosted by the [envigreen](https://github.com/envigreen) organisation on GitHub. They are mostly guidelines, not rules. All of this can be discussed - use your best judgement, and feel free to propose changes to this document in a pull request.
...
* **Check the [FAQ](https://github.com/envigreen/TreeO/discussions/categories/q-a) and the [discussions](https://github.com/envigreen/TreeO/discussions)** for a list of common questions and problems.
